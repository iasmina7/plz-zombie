...

{
    ...
    private void RotateTowardsTarget()
    {
        ...
        Quaternion targetRotaion=Quaternion.LookRotation(transform.forward,_targetDirection);
        Quaternion rotation =Quaternion.RotateTowards(transform.rotation,targetRotaion,_rotationspeed*Time.deltaTime);
